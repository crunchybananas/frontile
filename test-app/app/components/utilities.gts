...
import { Avatar, Collapsible, Divider, Spinner, VisuallyHidden } from '@frontile/utilities';
...
const Title: TOC<{
  ...
  <h1 class="inline-block mb-6 text-2xl font-bold border-b-4 border-primary" ...attributes>
    {{yield}}
  </h1>
</template>;
  ...
  <template>
    <div class="container p-4 mx-auto">
      ...
      <div class="mt-4">
        ...
        <div class="flex items-center space-x-4 py-2">
          <Avatar @size="xs" @src="https://i.pravatar.cc/150?img=1" @shape="square" />
          <Avatar @size="sm" @src="https://i.pravatar.cc/150?img=2" @shape="square" />
          <Avatar @size="md" @src="https://i.pravatar.cc/150?img=3" @shape="square" />
          <Avatar @size="lg" @src="https://i.pravatar.cc/150?img=4" @shape="square" />
          <Avatar @size="xl" @src="https://i.pravatar.cc/150?img=5" @shape="square" />
        </div>
