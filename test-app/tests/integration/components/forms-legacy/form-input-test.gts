...
module('Integration | Component | @frontile/forms-legacy/FormInput', function (hooks) {
  ...
  test('it renders html attributes', async function (assert) {
    await render(<template><FormInput @label="Name" name="some-name" data-test-input /></template>);
  ...
  test('it should have id attr with matching label attr `for`', async function (assert) {
    await render(<template><FormInput @label="Name" data-test-input /></template>);
    ...
    await render(
      <template>
        <div class="my-container">
          <FormInput data-test-input @errors={{array "This field is required"}} @label="Name" />
        </div>
      </template>
    );
  ...
  test('do not show error messages if errors has no elements', async function (assert) {
    ...
    await render(
      <template>
        <div class="my-container">
          <FormInput data-test-input @errors={{errors}} @label="Name" />
        </div>
      </template>
    );
  ...
  test('it adds container class from @containerClass arg', async function (assert) {
    await render(<template><FormInput @containerClass="my-container-class" /></template>);
