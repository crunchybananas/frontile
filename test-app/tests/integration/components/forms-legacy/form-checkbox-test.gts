...
module('Integration | Component | @frontile/forms-legacy/FormCheckbox', function (hooks) {
  setupRenderingTest(hooks);

  test('it renders with the label from argument', async function (assert) {
    await render(<template><FormCheckbox data-test-input @label="My Checkbox Input" /></template>);
    assert.dom('[data-test-id="form-field-label"]').hasText('My Checkbox Input');
  });
  ...
  test('it should have id attr with matching label attr `for`', async function (assert) {
    await render(<template><FormCheckbox @label="Something Else" data-test-input /></template>);
  ...
  test('it renders the `name` from args', async function (assert) {
    await render(<template><FormCheckbox data-test-input @name="my-input" /></template>);
  ...
  test('it does not mutates the value directly', async function (assert) {
    ...
    assert.equal(myValue.current, false);
  });
  ...
  test('it marks the input as checked if value matches', async function (assert) {
    ...
    await render(
      <template>
        <FormCheckbox data-test-input @label="My Checkbox Input" @checked={{myValue.current}} />
      </template>
    );
  ...
  test('it adds container class from @containerClass arg', async function (assert) {
    await render(<template><FormCheckbox @containerClass="my-container-class" /></template>);
