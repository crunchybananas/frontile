...
module('Integration | Component | @frontile/forms-legacy/FormCheckboxGroup', function (hooks) {
  ...
  test('show error messages when errors array has items', async function (assert) {
    ...
    assert.dom('.my-container [data-test-id="form-field-feedback"]').doesNotExist();
