...
module('Integration | Component | @frontile/forms-legacy/FormField::Checkbox', function (hooks) {
  setupRenderingTest(hooks);

  test('it renders with html attributes', async function (assert) {
    await render(<template><Checkbox name="some-name" data-test-checkbox /></template>);
  ...
  test('it renders @name arg', async function (assert) {
    await render(<template><Checkbox @name="my-name" data-test-checkbox /></template>);
  ...
  test('renders @checed arg, does not mutate it by default', async function (assert) {
    ...
    await render(<template><Checkbox data-test-checkbox @checked={{value.current}} /></template>);
  ...
  test('should call @onChange function arg', async function (assert) {
    ...
    await render(
      <template>
        <Checkbox data-test-checkbox @checked={{value.current}} @onChange={{setName}} />
      </template>
    );
