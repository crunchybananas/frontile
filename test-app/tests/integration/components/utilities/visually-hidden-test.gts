...
module('Integration | Component | @frontile/utilities/VisuallyHidden', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.dom('[data-test-id="my-element"]').hasText('This text will be visually hidden');
