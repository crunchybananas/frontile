...
module('Integration | Component | ButtonGroup | @frontile/buttons', function (hooks) {
  ...
  module('Style classes', () => {
    module('@appearance', () => {
      ...
      test('it adds class for outlined appearance', async function (assert) {
        ...
        await render(
          <template>
            <ButtonGroup data-test-id="group" @appearance={{appearance.current}} as |g|>
              <g.Button data-test-id="button">Button</g.Button>
              <g.ToggleButton data-test-id="toggle">Toggle</g.ToggleButton>
            </ButtonGroup>
          </template>
    ...
    module('@intent', () => {
      test('it adds class for the an intent', async function (assert) {
        ...
        await render(
          <template>
            <ButtonGroup data-test-id="group" @intent={{intent.current}} as |g|>
              <g.Button data-test-id="button">Button</g.Button>
              <g.ToggleButton data-test-id="toggle">Toggle</g.ToggleButton>
            </ButtonGroup>
          </template>
