...
module('Integration | Component | ToggleButton | @frontile/buttons', function (hooks) {
  ...
  module('@isSelected', () => {
    test('adds aria-pressed', async function (assert) {
      ...
      await render(
        <template>
          <ToggleButton @isSelected={{isSelected.current}} data-test-id="button">My ToggleButton</ToggleButton>
        </template>
      );
  ...
  module('@onChange', () => {
    test('calls onChange argument', async function (assert) {
      ...
      await render(
        <template>
          <ToggleButton @isSelected={{false}} @onChange={{onChange}} data-test-id="button">
            My ToggleButton
          </ToggleButton>
        </template>
      );
